    ...
    <AuthProvider>
      <Routes>
        <Route path='/' element={<App />}>
          ...
          <Route path='products/:id/debug' element={
            <ProtectedRoute allowedRoles={['user', 'dermatologist', 'admin']}>
              <ProductDetailDebug />
            </ProtectedRoute>
          } />
          ...
          <Route path='cart-simple' element={
            <ProtectedRoute allowedRoles={['user']}>
              <SimpleCart />
            </ProtectedRoute>
          } />
          <Route path='cart-debug' element={
            <ProtectedRoute allowedRoles={['user']}>
              <CartDebug />
            </ProtectedRoute>
          } />
          <Route path='cart-debug-page' element={
            <ProtectedRoute allowedRoles={['user']}>
              <CartDebugPage />
            </ProtectedRoute>
          } />
          ...
          <Route path='test/buynow' element={
            <ProtectedRoute allowedRoles={['user', 'dermatologist', 'admin']}>
              <BuyNowTest />
            </ProtectedRoute>
          } />
