    ...
    const fetchPaymentOptions = async () => {
        try {
            const response = await axios.get(
                `http://localhost:5000/api/payments/options?amount=${cart.totalAmount}`
            );
            ...
            >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div style={{ flex: 1 }}>
                                        ...
                                        >
                                            $
                                            {paymentOptions.full_payment.amount.toFixed(
                                                2
                                            )}
                                        </div>
                                    </div>
                                    ...
                                    >
                                        ...
                                        <div style={{ flex: 1 }}>
                                            ...
                                            >
                                                ...
                                                >
                                                    SAVE $
                                                    {paymentOptions.cash_discount.savings.toFixed(
                                                        2
                                                    )}
                                                </span>
                                            </div>
                                            ...
                                            >
                                                ...
                                                >
                                                    $
                                                    {paymentOptions.cash_discount.amount.toFixed(
                                                        2
                                                    )}
                                                </span>
                                            </div>
                                ...
                                {paymentOptions.emi_options.available && (
                                    ...
                                    >
                                        ...
                                        <div style={{ flex: 1 }}>
                                            ...
                                            >
                                                {paymentOptions.emi_options.plans.map(
                                                    (plan, index) => (
                                                        <div
                                                            key={index}
                                                            style={{
                ...
                >
                    ...
                    <div style={{ marginBottom: "20px" }}>
                        ...
                        {selectedPaymentType === "cash_discount" &&
                            paymentOptions?.cash_discount.available && (
                                <div
                                    style={{
                                        display: "flex",
                            ...
                            {selectedPaymentType === "emi" &&
                                paymentOptions?.emi_options.available && (
                                    ...
                                    >
                                        Starting from $
                                        {
                                            paymentOptions.emi_options.plans[0]
                                                ?.monthly_amount
                                        }
                                        /month
                                    </div>
