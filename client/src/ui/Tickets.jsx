        ...
        <div style={{
          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            <p style={{ color: '#6b7280', fontSize: '14px' }}>
              Describe your skin concerns and get professional advice
            </p>
          </div>
          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            <textarea
              ...
              placeholder="Please describe your skin concern in detail. Include symptoms, duration, products you've tried, and any other relevant information..."
              rows="6"
              style={{
                width: '100%',
                padding: '12px',
