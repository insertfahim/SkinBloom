    ...
    const updatePriceAlert = async (productId, enabled, targetPrice) => {
        try {
            const { data } = await API.put(`/wishlist/update/${productId}`, {
                priceAlert: {
                    enabled,
                    targetPrice: enabled ? targetPrice : undefined,
                },
            });
            setWishlist(data);
        } catch (err) {
    ...
    return (
        <div style={{ minHeight: "100vh", background: "#fafafa" }}>
            ...
            >
                ...
                >
                    Save your favorite products and get notified when prices
                    drop
                </p>
            </div>
            ...
            >
                ...
                {wishlist.products.length === 0 ? (
                    ...
                    >
                        ...
                        >
                            Start building your perfect skincare collection by
                    ...
                    <>
                        ...
                        >
                            {wishlist.products.map((item) => (
                                <WishlistItem
                                    ...
                                    onUpdateNotes={(notes) =>
                                        updateNotes(item.productId._id, notes)
                                    }
                                />
                            ))}
                        </div>
                        ...
                        >
                            ...
                            >
                                Discover more products to complete your skincare
                                routine
                            </p>
                            <Link
                                to="/products"
